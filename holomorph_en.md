...
[^2]: *Isomorphism* from ἴσος (ísos) *equal* and μορφή (morphē) *form*, a *mapping* between two mathematical structures by which parts of one structure are *bijectively* (invertible uniquely) *mapped* to equivalent parts of another structure.  
